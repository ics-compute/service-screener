...
sequential = True if sequential in _C.CLI_TRUE_KEYWORD_ARRAY or sequential is True else False
...
_cli_options['sequential'] = sequential
...
Config.set('sequential', sequential)
